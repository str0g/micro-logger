...
#define CURRENT_FILE_NAME_ONLY_ (strrchr(__FILE__, '/') ? strrchr(__FILE__, '/') + 1 : __FILE__) // runtime

#ifndef NODEBUG
#define MSG_DEBUG(fmt, ...) \
    micro_logger_logme(LVL_DEBUG, CURRENT_FILE_NAME_ONLY_, __FUNCTION__, __LINE__, fmt, ##__VA_ARGS__)
#define MSG_ENTER() \
    micro_logger_logme(LVL_TRACE, CURRENT_FILE_NAME_ONLY_, __FUNCTION__, __LINE__, "%s", "--ENTER--")
#define MSG_EXIT() \
    micro_logger_logme(LVL_TRACE, CURRENT_FILE_NAME_ONLY_, __FUNCTION__, __LINE__, "%s", "--EXIT--")
#else
#define MSG_DEBUG(fmt, ...)
#define MSG_ENTER()
#define MSG_EXIT()
...
#define MSG_INFO(fmt, ...) \
    micro_logger_logme(LVL_INFO, CURRENT_FILE_NAME_ONLY_, __FUNCTION__, __LINE__, fmt, ##__VA_ARGS__)
#define MSG_WARN(fmt, ...) \
    micro_logger_logme(LVL_WARN, CURRENT_FILE_NAME_ONLY_, __FUNCTION__, __LINE__, fmt, ##__VA_ARGS__)
#define MSG_ERROR(fmt, ...) \
    micro_logger_logme(LVL_ERROR, CURRENT_FILE_NAME_ONLY_, __FUNCTION__, __LINE__, fmt, ##__VA_ARGS__)
#define MSG_CRITICAL(fmt, ...) \
    micro_logger_logme(LVL_CRITICAL, CURRENT_FILE_NAME_ONLY_, __FUNCTION__, __LINE__, fmt, ##__VA_ARGS__)
